...
public class SoulBrewingStandMenu extends AbstractContainerMenu {
    ...
    public SoulBrewingStandMenu(int i, Inventory inventory) {
        this(i, inventory, new SimpleContainer(5), new SimpleContainerData(2));
    }

    public SoulBrewingStandMenu(int i, Inventory inventory, Container container, ContainerData containerData) {
    ...
    static class PotionSlot extends Slot {
        ...
        public Identifier getNoItemIcon() {
            return SoulBrewingStandMenu.EMPTY_SLOT_POTION;
        }
    }
    ...
    static class FuelSlot extends Slot {
        ...
        public Identifier getNoItemIcon() {
            return SoulBrewingStandMenu.EMPTY_SLOT_FUEL;
        }
    }
}
